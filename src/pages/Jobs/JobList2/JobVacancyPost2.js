                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col lg={10}>
                                                            <div className="mt-3 mt-lg-0">
                                                                <h5 className="fs-17 mb-1"><Link to="/jobdetails" className="text-dark">{jobVacancyList2Details.jobDescription}</Link> <small className="text-muted fw-normal">({jobVacancyList2Details.experience})</small></h5>
